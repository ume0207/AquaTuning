...
- 元ロゴを参照して生成した、文字なし・背景透明の専用ロゴマークをヘッダーへ配置
- クリアブルー、ミントブルー、アンダーウォーターの3テーマを切替可能
- `/designs` にプレゼン用の3案比較ページを用意
- デスクトップのAqua Tuning写真素材を最適化し、講座紹介・自己紹介トーク・コンテンツサムネイルへ反映
- 講座紹介にAqua Tuningの理念と講師・ナビゲーター紹介を追加
...
- 3案比較: https://aquatuning.pages.dev/designs
